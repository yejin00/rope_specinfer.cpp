...
static const struct ggml_type_traits_cpu type_traits_cpu[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_Q2_0_HEAD] = {
        .from_float               = quantize_row_q2_0_head,
        .vec_dot                  = ggml_vec_dot_q2_0_head_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_Q3_0_HEAD] = {
        .from_float               = quantize_row_q3_0_head,
        .vec_dot                  = ggml_vec_dot_q3_0_head_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_Q8_0_HEAD] = {
        .from_float               = quantize_row_q8_0_head,
        .vec_dot                  = ggml_vec_dot_q8_0_head_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
